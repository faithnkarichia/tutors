...
<!-- Mirrored from www.myhomeworkshark.com/becomeatutor by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Dec 2018 01:02:19 GMT -->
...
<head>
    ...
    <!-- plugins -->
    <title>Myhomeworkhelp: Become a tutor</title>
    <!-- CSRF Token -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3 col-md-8 offset-lg-3">
                            <div class="misc-box">
                                <h3 class="margin-b-0 text-center">Make money writing articles! </h3>
                                <p class="text-center">
                                    Sign Up today and get lots of benefits.
                                </p><hr>
                                <form role="form" method="post" class="margin-b-20" action="https://www.myhomeworkshark.com/registertutor">
                            ...
                            <span class="copyright">&copy; Copyright 2016-2017. Myhomeworkshark.com</span>
                        </div>
                    </div>
                </div>
            </div>
